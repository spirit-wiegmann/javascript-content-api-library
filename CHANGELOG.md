...
## [12.0.0](https://github.com/spirit-wiegmann/javascript-content-api-library/compare/v10.24.0...v12.0.0) (2026-01-15)

### ⚠ BREAKING CHANGES

* **node-24:** - Update Node.js from 20.x to 24.x in all CI configurations
...
* **node-24:** ⬆️ upgrade to Node.js 24, update dependencies, and migrate to release-it ([1579e3c](https://github.com/spirit-wiegmann/javascript-content-api-library/commit/1579e3cc1f6f1ff73e173da3dfe43084d00f136d))
* **release:** 🏷️ rename packages to `@crownpeak/fsxa-publishing-test-api` and `@crownpeak/fsxa-publishing-test-proxy-api`, bump version to 11.0.0, and update CI workflow ([1796ec0](https://github.com/spirit-wiegmann/javascript-content-api-library/commit/1796ec052e1e290efc635897de2d1b14d79da58e))
